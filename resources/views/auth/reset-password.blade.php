        ...
        <form method="POST" action="{{ route('password.store') }}">
            ...
            <div class="mb-3">
                ...
                <div class="input-group">
                    ...
                    <x-text-input id="email" class="form-control form-control-lg bg-light border-0 shadow-sm"
            ...
            <!-- New Password -->
            <div class="mb-3">
                <x-input-label for="password" :value="__('New Password')" class="form-label fw-semibold" />
                <div class="input-group">
                    <span class="input-group-text bg-light border-0">
