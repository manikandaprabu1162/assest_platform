...
<head>
    ...
    <title>Verify email · AssetMarket</title>
...
<body class="bg-light d-flex align-items-center min-vh-100 py-4">
    ...
    <!-- 
        LARAVEL EMAIL VERIFICATION NOTICE – fully functional, Bootstrap only.
        All Laravel directives (@if, session, route, csrf) are preserved.
            ...
            <div class="col-12 col-sm-10 col-md-8 col-lg-6 col-xl-5 col-xxl-4">
                ...
                <div class="card shadow-lg border-0 rounded-4 overflow-hidden">
                    ...
                    <div class="card-body p-4 p-lg-5">
                        ...
                        <div class="alert alert-info bg-info bg-opacity-10 border-0 d-flex align-items-center mb-4"
                            role="alert">
                        ...
                        <div
                            class="d-flex flex-column flex-sm-row align-items-center justify-content-between gap-3 mt-3">
