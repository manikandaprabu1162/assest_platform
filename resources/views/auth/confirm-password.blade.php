...
<head>
    ...
    <title>Confirm password · AssetMarket</title>
...
<body class="bg-light d-flex align-items-center min-vh-100 py-4">
    ...
    <!-- 
        LARAVEL CONFIRM PASSWORD FORM – fully functional, Bootstrap only.
        All Laravel directives (@csrf, errors) are preserved.
            ...
            <div class="col-12 col-sm-10 col-md-8 col-lg-6 col-xl-5 col-xxl-4">
                ...
                <div class="card shadow-lg border-0 rounded-4 overflow-hidden">
                    ...
                    <div class="card-body p-4 p-lg-5">
                        ...
                        <div class="alert alert-warning bg-warning bg-opacity-10 border-0 d-flex align-items-center mb-4"
                            role="alert">
